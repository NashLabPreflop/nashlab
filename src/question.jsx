    ...
    spots: [
      ...
      },
      {
        ...
        bands: [
              ...
              { action: "ALLIN", min: 0.05, range: `88:0.253, 55:0.001, A9s:0.004, A7s:0.006, A6s:0.062, A5s:0.007, A4s:0.255, A3s:0.421, A2s:0.439, AKo:0.010, AQo:0.575, A8o:0.003, A7o:0.093, A5o:0.127, KTs:0.011, KTo:0.093, QJs:0.012` },          
        ],
        answerBuilder: (pattern, hand, _weight, optionsBB) =>
          ({ index: answerByRangeSpec(optionsBB, hand, pattern.bands, "fold", 0.5) })
      },  
      ...
      },       
      {
        ...
        bands: [
              ...
              { action: "ALLIN", min: 0.05, range: `KK:0.613, QQ:0.136, JJ:0.072, TT:0.001, 88:0.001, 77:0.004, 66:0.229, 55:0.136, AKs:0.339, A5s:0.298, A4s:0.432, A3s:0.138, A2s:0.002, AKo:0.928` },
            ],
        answerBuilder: (pattern, hand, _weight, optionsBB) =>
          ({ index: answerByRangeSpec(optionsBB, hand, pattern.bands, "fold", 0.5) })
      },         
